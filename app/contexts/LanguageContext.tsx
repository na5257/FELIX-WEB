...
const translations: Record<Language, Record<string, string>> = {
  da: {
    ...
    'sci.animation.body': 'Hjernen arbejder ikke kun gennem aktivitet, men gennem præcis timing. I velfungerende netværk koordineres signaler inden for snævre tidsvinduer, så perception, følelsesregulering og kognitiv kontrol kan integreres effektivt. Ved depression kan denne tidslige organisering blive mindre stabil, så kommunikationen mellem netværk bliver mindre præcis og mindre fleksibel.',
  ...
  en: {
    ...
    'sci.animation.body': 'The brain operates not only through activity, but through timing. In well-functioning networks, signals are coordinated within narrow temporal windows so that perception, affect regulation, and cognitive control can be integrated efficiently. In depression, that temporal organization may become less stable, leaving communication between networks less precise and less flexible.',
