    ...
    <div className="bg-[var(--background)]">
      ...
      <section className="py-20 md:py-28 gradient-sage leaf-texture">
        <div className="relative max-w-3xl mx-auto px-6">
          ...
          <div className="card-nature p-10 md:p-14">
            <div className="grid md:grid-cols-3 gap-10 md:gap-8 text-center">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[var(--color-forest)]/8 flex items-center justify-center mb-4">
                ...
                <h3 className="font-medium text-[var(--foreground)] text-sm mb-1.5">{t("contact.location")}</h3>
                <p className="text-sm text-[var(--muted)] leading-relaxed">{t("contact.location.value")}</p>
              </div>

              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[var(--color-sage)]/8 flex items-center justify-center mb-4">
                ...
                <h3 className="font-medium text-[var(--foreground)] text-sm mb-1.5">{t("contact.email")}</h3>
                <a href="mailto:nikolas.johansen.aasheim@regionh.dk" className="text-sm text-[var(--color-sage)] hover:text-[var(--color-forest)] transition-colors break-all">
                  nikolas.johansen.aasheim@regionh.dk
                </a>
              </div>

              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-[var(--color-gold)]/8 flex items-center justify-center mb-4">
                ...
                <h3 className="font-medium text-[var(--foreground)] text-sm mb-1.5">{t("contact.registration")}</h3>
                <a href="https://clinicaltrials.gov/ct2/show/NCT05680220" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--color-sage)] hover:text-[var(--color-forest)] transition-colors">
                  {t("contact.registration.value")}
                </a>
              </div>
            </div>

            <div className="mt-12 pt-10 border-t border-[var(--color-sage)]/10 text-center">
              <a
                href="mailto:nikolas.johansen.aasheim@regionh.dk"
                className="inline-flex items-center gap-2.5 px-8 py-3.5 bg-[var(--color-forest)] text-white rounded-full hover:bg-[var(--color-forest-deep)] transition-all duration-300 text-sm font-medium"
              >
